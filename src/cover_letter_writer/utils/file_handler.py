"""File handling utilities for Cover Letter Writer."""
...
class FileHandler:
    ...
    def save_cover_letter(
        ...
        output_dir: str,
        filename_pattern: str = "cover_letter_optimized_{timestamp}.md",
    ) -> Path:
        """
        Save cover letter content to file.

        Args:
            cover_letter_content: Cover letter markdown content
    ...
    def save_feedback_history(
        ...
        output_dir: str,
        filename_pattern: str = "cover_letter_review_history_{timestamp}.md",
    ) -> Path:
        """
    ...
    def format_feedback_history(feedback_history: list) -> str:
        ...
        """
        lines = ["# Cover Letter Review History\n"]
    ...
    @staticmethod
    def save_translated_cover_letter(
        cover_letter_content: str,
        output_dir: str,
        language_code: str,
        base_filename: str,
        ...
        """
        Save translated cover letter content to file with language code in filename.

        Args:
            cover_letter_content: Translated cover letter markdown content
            output_dir: Output directory
            language_code: Two-letter language code (e.g., 'de', 'fr')
            base_filename: Base filename from English cover letter (without extension)
