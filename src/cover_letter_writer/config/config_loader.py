"""Configuration loader for Cover Letter Writer."""
...
class Config:
    ...
    def _load_config(self, config_file: str | None) -> dict[str, Any]:
        ...
        if config_file:
            ...
            default_config_path = Path(__file__).parent / "cover_letter_writer.yaml"
    ...
    def _load_from_env(config: dict[str, Any]) -> dict[str, Any]:
        ...
        if os.getenv("MAX_ITERATIONS"):
            config["writer"]["max_iterations"] = int(os.getenv("MAX_ITERATIONS"))
        ...
        if os.getenv("TRANSLATION_LLM_PROVIDER"):
            config["translation"]["llm_provider"] = os.getenv(
    ...
    def llm_model(self) -> str:
        """Get LLM model."""
        return self.get("llm.model", "gpt-5.1")
    ...
    def max_iterations(self) -> int:
        """Get max iterations."""
        return self.get("writer.max_iterations", 3)
    ...
    @property
    def cover_letter_filename_pattern(self) -> str:
        """Get cover letter filename pattern."""
        return self.get(
            "output.cover_letter_filename_pattern",
            "cover_letter_optimized_{timestamp}.md",
        )
    ...
    def feedback_filename_pattern(self) -> str:
        ...
        return self.get(
            "output.feedback_filename_pattern",
            "cover_letter_review_history_{timestamp}.md",
        )
